    ...
    $.supersized = function(options){
    	...
    	base._start = function(){
			...
			if (base.options.slides.length > 1){
				if(base.options.slides.length > 2){
					...
					var imgPrev = !isMobile ? $('<img src="'+base.options.slides[loadPrev].image+'"/>') : $('<img src="'+base.options.slides[loadPrev].image_small+'"/>');
			...
			var img = !isMobile ? $('<img src="'+api.getField('image')+'"/>') : $('<img src="'+api.getField('image_small')+'"/>');
			...
			if (base.options.slides.length > 1){
				...
				var imgNext = !isMobile ? $('<img src="'+base.options.slides[loadNext].image+'"/>') : $('<img src="'+base.options.slides[loadNext].image_small+'"/>');
		...
		base.nextSlide = function(){
			...
			if (!$(targetList).html()){
				...
				var img = !isMobile ? $('<img src="'+base.options.slides[loadSlide].image+'"/>') : $('<img src="'+base.options.slides[loadSlide].image_small+'"/>'); 
			...
			if(base.options.slides.length > 1){
				var controlNavScaffold = $('<ul class="supersized-nav"></ul>');
				  ...
				  for (var i = 0; i < base.options.slides.length; i++) {
					  var n = j < 10 ? "0"+j : j
					controlNavScaffold.append('<li><a >' + n + '</a></li>');
					j++;
				  }
