...
// Initialize required variables and objects
			...
			if( parseInt($.browser.version, 10) == 7 && $.browser.msie && self.onePage && !self.mobile){
				$("body").css({"overflow-y":"hidden"});
			}
...
// Page buttons ==================================================================
			...
			$(window).scroll(function() {
				...
				if(self.url == self.homePg && self.scrollPos == 0 && self.onePage && !self.mobile){
					$("body").css({"overflow-y":"hidden"});
				}else{
					$("body").css({"overflow-y":"auto"});
				}
