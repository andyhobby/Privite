						...
						<div class="row all_back">
							...
							<div class="col-md-16">
								<div class="product_title">
									...
									<div class="text">2208 Precision Brushless Gimbal Motor</div>
								</div>
							</div>
							...
							<div class="col-md-16 col-lg-16 ie_fix1">
								...
								<div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 960px; height: 430px; background: #191919; overflow: hidden; background-color:#000000;">
									...
									<div u="slides" style="cursor: move; position: absolute; left: 280px; top: 0px; width: 640px; height: 426px; overflow: hidden;">
										<div>
											<img u="image" src="images/product/2208motor/1.png" />
											<img u="thumb" src="images/product/2208motor/1s.png" />
										</div>
										<div>
											<img u="image" src="images/product/2208motor/2.png" />
											<img u="thumb" src="images/product/2208motor/2s.png" />
										</div>
										<div>
											<img u="image" src="images/product/2208motor/3.png" />
											<img u="thumb" src="images/product/2208motor/3s.png" />
										</div>
									</div>
								...
								<div class="panel-group" id="accordion">
									...
									<div class="panel panel-default">
										...
										<div id="collapseThree" class="panel-collapse collapse in">
											<div class="panel-body">
												<ul>
													<li>Camera Range: 100-200 grams (GoPro size)</li>
													<li>Poles: 14P12S</li>
													<li>KV: 114</li>
													<li>Idle current amps: .03A</li>
													<li>Resistance: 23mh ohm</li>
													<li>Weight: 39 grams</li>
													<li>Voltage: 6-14volts (2-3 cell lipoly)</li>
													<li>Lower back mounting: 16*19mm</li>
													<li>Upper top mounting: 12mm hole to hole</li>
