jQuery(document).ready(function ($) {
	...
	//Zoom- in
	{$Duration: 1800, $Zoom: 1, $Easing: { $Zoom: $JssorEasing$.$EaseInCubic, $Opacity: $JssorEasing$.$EaseOutQuad }, $Opacity: 2 }
	/*,
	//Zoom+ out
	...
	*/
	...
	function ScaleSlider() {
		...
		if (parentWidth)
			jssor_slider1.$SetScaleWidth(Math.max(Math.min(parentWidth-20, 1140), 300));
		else
