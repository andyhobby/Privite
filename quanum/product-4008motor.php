						...
						<div class="row all_back">
							...
							<div class="col-md-16">
								<div class="product_title">
									...
									<div class="text">4008 Precision Brushless Gimbal Motor</div>
								</div>
							</div>
								...
								<div class="panel-group" id="accordion">
									<div class="panel panel-default">
										...
										<div id="collapseOne" class="panel-collapse collapse in">
											<div class="panel-body">
												<p>Have you been thinking about a brushless gimbal for your Multi-Rotor to feed your cinematographer inner child? Don’t get suckered into buying a sub-par overpriced kit. Do the math and look at the value of these ready to go Quanum brushless gimbal motors. They are pre-wound for optimal torque and smoothness and two sizes picked for the two most common class cameras. They come with a servo style connector and flexible cable, for plug-n-play compatibility with most Brushless Gimbal Controllers such as the one we offer below. Build your gimbal right the first time, One matched to your frame with quality parts verses a generic universal kit that will compromise overall performance from unnecessary weight and poor balance for your particular camera, and bypass the quality issues that plague Kit level components. Take your setup to the next level with Quanum Quality.</p>
												<p>The 4008 is the perfect size for a Nex5 Size camera (400-800g). It has a superb Fit and Finnish and is engineered to have a low lean profile for easy integration into your set-up. The 4008 has preloaded bearings for slop free precision mount, and 22 poles for ultra-smooth motion. This brushless gimbal motor is perfect for an upgrade to a kit setup, or the base for a DIY custom gimbal. The 4008 can even be the base for the fast growing DIY hand held steady cam platforms, for the budget minded India film. Whatever your use, if it needs to be stabilized Quanum Brushless Gimbal Motors are up to the task.</p>
											</div>
										</div>
									</div>
									...
									<div class="panel panel-default">
										...
										<div id="collapseThree" class="panel-collapse collapse in">
											<div class="panel-body">
												<ul>
													<li>Camera Range: 400-800 grams (nex5 size)</li>
													<li>poles: 22P24S</li>
													<li>KV: 56</li>
													<li>Idle current amps: .04A</li>
													<li>Resistance: 14mh ohm</li>
													<li>Weight: 88.5 grams</li>
													<li>Voltage: 6-14volts (2-3 cell lipoly)</li>
													<li>Lower back mounting: 19*25mm</li>
													<li>Upper top mounting: 15mm hole to hole</li>
													<li>Connection: 3 wire servo style connection 190mm long leads</li>
													<li>Mounting Thread: M3</li>
												</ul>
											</div>
										</div>
									</div>
