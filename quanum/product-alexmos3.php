						...
						<div class="row all_back">
							...
							<div class="col-md-16">
								<div class="product_title">
									...
									<div class="text">AlexMos Brushless Gimbal Controller 3</div>
								</div>
							</div>
							...
							<div class="col-md-16 col-lg-16 ie_fix1">
								...
								<div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 960px; height: 430px; background: #191919; overflow: hidden; background-color:#000000;">
									...
									<div u="slides" style="cursor: move; position: absolute; left: 280px; top: 0px; width: 640px; height: 426px; overflow: hidden;">
										<div>
											<img u="image" src2="images/product/alexmos3/1.png" />
											<img u="thumb" src="images/product/alexmos3/1s.png" />
										</div>
										<div>
											<img u="image" src2="images/product/alexmos3/2.png" />
											<img u="thumb" src="images/product/alexmos3/2s.png" />
										</div>
										<div>
											<img u="image" src2="images/product/alexmos3/3.png" />
											<img u="thumb" src="images/product/alexmos3/3s.png" />
										</div>
										<div>
											<img u="image" src2="images/product/alexmos3/4.png" />
											<img u="thumb" src="images/product/alexmos3/4s.png" />
										</div>
										<div>
											<img u="image" src2="images/product/alexmos3/5.png" />
											<img u="thumb" src="images/product/alexmos3/5s.png" />
										</div>
										<div>
											<img u="image" src2="images/product/alexmos3/6.png" />
											<img u="thumb" src="images/product/alexmos3/6s.png" />
										</div>
										<div>
											<img u="image" src2="images/product/alexmos3/7.png" />
											<img u="thumb" src="images/product/alexmos3/7s.png" />
										</div>
										<div>
											<img u="image" src2="images/product/alexmos3/8.png" />
											<img u="thumb" src="images/product/alexmos3/8s.png" />
										</div>
									</div>
								...
								<div class="panel-group" id="accordion">
									...
									<div class="panel panel-default">
										...
										<div id="collapseThree" class="panel-collapse collapse">
											<div class="panel-body">
												<ul>
													<li>verall Length: 740mm</li>
													<li>Hull Length: 650mm</li>
													<li>Beam: 180mm</li>
													<li>Weight: 1140g (w/out battery)</li>
									...
									<div class="panel panel-default">
										...
										<div id="collapseFour" class="panel-collapse collapse">
											<div class="panel-body">
												<ul>
													<li>2 axis</li>
													<li>3rd axis expansion</li>
													<li>MPU6050</li>
													<li>Highly flexible silicon IMU cable</li>
													<li>Silicon connector for 3rd axis to 2 axis board.</li>
												</ul>
											</div>
										</div>
									</div>
