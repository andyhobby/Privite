						...
						<div class="row all_back">
							...
							<div class="col-md-16">
								<div class="product_title">
									...
									<div class="text">Snow Ski 270mm</div>
								</div>
							</div>
							...
							<div class="col-md-16 col-lg-16 ie_fix1">
								...
								<div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 960px; height: 430px; background: #191919; overflow: hidden; background-color:#000000;">
									...
									<div u="slides" style="cursor: move; position: absolute; left: 280px; top: 0px; width: 640px; height: 426px; overflow: hidden;">
										<div>
											<img u="image" src2="images/product/snow_ski/1.png" />
											<img u="thumb" src="images/product/snow_ski/1s.png" />
										</div>
										<div>
											<img u="image" src2="images/product/snow_ski/2.png" />
											<img u="thumb" src="images/product/snow_ski/2s.png" />
										</div>
										<div>
											<img u="image" src2="images/product/snow_ski/3.png" />
											<img u="thumb" src="images/product/snow_ski/3s.png" />
										</div>
										<div>
											<img u="image" src2="images/product/snow_ski/4.png" />
											<img u="thumb" src="images/product/snow_ski/4s.png" />
										</div>
									</div>
									...
									<div class="panel panel-default">
										...
										<div id="collapseOne" class="panel-collapse collapse in">
											<div class="panel-body">
												<p>The Quanum R/C Snow Ski is made of high strength non-coloured Nylon that wont get brittle in cold weather.. It can be used on variety of planes and comes with a spare spring for left/right conversions.</p>
												<p>It is very simple to install with all required hardware included and the specially designed fin ensures straight tracking and less yawing during landing and takeoff.</p>
												<p>An excellent addition to any .40 or .60 size or larger R/C plane.</p>
											</div>
										</div>
									</div>
									...
									<div class="panel panel-default">
										...
										<div id="collapseTwo" class="panel-collapse collapse">
											<div class="panel-body">
												<ul>
													<li>x Ski</li>
													<li>2 x Spring(for right/left side conversion)</li>
													<li>1 x bolt</li>
													<li>1 x Shaft</li>
												</ul>
											</div>
